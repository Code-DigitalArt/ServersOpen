...
$data = 'expressionengine';	// your database
$user = 'eeuser';	// your db userid
$pass = 'dskXcgR6l6P1wUdvfOw2zkGjt38ZeYx1SdmZcR9lrtnrqRMLR18Ie0hSzQ6';	// your db password
$char = '';	// your db charset you can leave this blank
// Search replace details

$do = [
	// 'http://baileysc.uldev.co/',
	// 'ttp://baileysc.uldev.co/',
	// 'baileysc.uldev.co/',
	'http://drbaileyskincare.com/info/',
	// 'http://www.drbaileyskincare/'
];

$tables = array('exp_channel_data');
...
foreach ($do as $srch) {
	...
	echo "Replaced with: " . $rplc . "<br>";
	echo "Tables Scanned: " . $report['tables'] . "<br>";
	echo "Rows Scanned: " . $report['rows'] . "<br>";
	echo "Cells Changed: " . $report['change'] . "<br>";
	echo "DB Updated: " . $report['updates'] . "<br>";
	echo "Time Elapsed: " . $time . "<br>";
