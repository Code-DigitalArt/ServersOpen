...
error_reporting(-1);
// DB details
$host = '208.185.97.42';	// normally localhost, but not necessarily.
$data = 'media_ee';	// your database
$user = 'media_ee';	// your db userid
$pass = '-9#Y6L2pja*c+x';	// your db password
$char = '';	// your db charset you can leave this blank
// Search replace details
$srch = 'john@LabradoTeam.com';
$rplc = '/';
// Tables to scanned
...
echo PHP_EOL; var_export($report['found']);
